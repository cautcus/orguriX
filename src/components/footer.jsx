    ...
    <>
      <footer>
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          OrganiX is a passionate community focused on promoting the best organic products. Collaborate with suppliers, maintain high sustainability standards, and help us make a positive impact on the environment.
          </p>
