...
const TeamMember = ({ initials, name, title, image, insta, linkin }) => {
  ...
  return (
    <div
      className="relative p-24 m-4 border-2 border-black shadow-lg rounded-lg text-center transform transition-transform hover:scale-105 "
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
    >
      <h2 className="text-5xl font-bold">{initials}</h2>
    ...
    <section className="py-14">
      <div className="max-w-screen-xl mx-auto px-4 text-center md:px-8">
        <div className="max-w-xl mx-auto">
          <h3 className="text-gray-800 capitalize font-bold text-3xl sm:text-4xl">
            Meet Our Talents
          </h3>
          <p className="text-gray-600 mt-3">
            Hover to reveal the faces and roles behind the initials. Together,
